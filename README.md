...
This book is cread using the template described below.

https://github.com/jtr13/bookdown-template

Since I am using more than one GitHub account, I modified the last step, i.e., before commit, I was required to do an extra work. I can be done by using `usethis` package to set authentication as well.
