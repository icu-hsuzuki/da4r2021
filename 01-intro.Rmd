...
#### From Professor Shimizu's lecture, slide 3

**Insights** from data may come
from a well conceived **visualization** of the data,
from modern methods of statistical learning and **model selection** as well as from time-honored formal statistical procedures.
